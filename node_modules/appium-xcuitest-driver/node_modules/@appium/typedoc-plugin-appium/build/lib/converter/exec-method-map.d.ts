 ...
 */
export declare function convertExecuteMethodMap({ log, parentRefl, execMethodMapRefl, knownMethods, strict, isPluginCommand, }: ConvertExecuteMethodMapOpts): ExecMethodDataSet;
