 ...
 */
function convertExecuteMethodMap({ log, parentRefl, execMethodMapRefl, knownMethods, strict = false, isPluginCommand = false, }) {
    ...
    for (const newMethodProp of newMethodProps) {
        ...
        const commentData = (0, comment_1.deriveComment)({ refl: methodRefl, comment, knownMethods: knownMethods });
        commandRefs.add(new model_1.ExecMethodData(log, command, methodRefl, script, {
            requiredParams,
            optionalParams,
