 ...
 */
export declare function convertMethodMap({ log, methodMapRefl, parentRefl, knownClassMethods, knownBuiltinMethods, strict, isPluginCommand, }: ConvertMethodMapOpts): RouteMap;
