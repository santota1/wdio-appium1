 ...
 */
function cloneSignatureReflection(sig, parent, type) {
    const newSig = new typedoc_1.SignatureReflection(sig.name, typedoc_1.ReflectionKind.CallSignature, parent);
    lodash_1.default.assign(newSig, lodash_1.default.pick(sig, SIGNATURE_REFLECTION_CLONE_FIELDS));
...
exports.cloneSignatureReflection = cloneSignatureReflection;
